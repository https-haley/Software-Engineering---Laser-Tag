...
If you do not have Git installed, you can download the project as a ZIP file instead. Skip this step if you have already downloaded the code using Git.

### Steps:

Open the repository page in your web browser on the VM.
...
```
# **Other Installation Instructions (once the code is on your machine and you are in the directory):**
